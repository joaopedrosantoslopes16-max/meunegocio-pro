    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center px-4">
        <div className="text-center">
          <p className="text-gray-500 dark:text-gray-400 mb-4">Você precisa configurar seu negócio primeiro.</p>
          <Link href="/gerar-kit" className="gradient-brand text-white font-bold py-3 px-6 rounded-xl inline-block">Configurar negócio</Link>
        </div>
      </div>
    );
  }
