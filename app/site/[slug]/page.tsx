...
import { buildWhatsAppLink, formatPhoneDisplay } from "@/lib/whatsapp-utils";
...
// ── Descrição automática por nicho ─────────────────────────
...
export default async function MiniSitePage({ params }: Props) {
  ...
  // Serviços: usa os do negócio, ou os padrão do nicho
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", fontFamily: "'Inter', system-ui, sans-serif", WebkitFontSmoothing: "antialiased", color: "#111", paddingBottom: "80px" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden" }}>
        ...
        {/* PERFIL — avatar sobreposto à capa */}
        <div style={{ position: "relative", padding: "0 20px", maxWidth: "560px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <a href={waMain} target="_blank" rel="noopener noreferrer" className="wa-btn" style={{
              display: "flex", alignItems: "center", justifyContent: "center", gap: "10px",
              background: "#25D366", color: "#fff", fontWeight: 800, fontSize: "16px",
            ...
            {business.instagram && (
              <a href={`https://instagram.com/${business.instagram.replace("@","")}`} target="_blank" rel="noopener noreferrer" style={{
                display: "flex", alignItems: "center", justifyContent: "center", gap: "10px",
                background: "#fff", border: "1.5px solid #e5e7eb", color: "#333", fontWeight: 700, fontSize: "15px",
                padding: "14px 24px", borderRadius: "16px", transition: "border-color .2s",
              }}>
      ...
      <section style={{ padding: "0 20px 40px", maxWidth: "560px", margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.75, marginBottom: "20px" }}>
          {aboutText}
        </p>
      ...
      <section style={{ padding: "40px 20px", background: "#f9f9f9" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {/* Serviço principal — destaque */}
            <div style={{
              background: "#fff", borderRadius: "18px", padding: "18px 20px",
              display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px",
              border: `1.5px solid ${color}30`, boxShadow: `0 4px 20px ${color}12`,
            }}>
              ...
              <a href={buildWhatsAppLink(business.whatsapp, `Olá! Quero saber mais sobre ${business.main_service}.`)} target="_blank" rel="noopener noreferrer" style={{
                display: "flex", alignItems: "center", gap: "6px", background: "#25D366",
                color: "#fff", fontSize: "12px", fontWeight: 700, padding: "8px 14px", borderRadius: "10px", flexShrink: 0,
              }}>
            ...
            {rawServices.filter((s: string) => s !== business.main_service).map((s: string, i: number) => (
              <div key={i} className="svc-card" style={{
                ...
                <a href={buildWhatsAppLink(business.whatsapp, `Olá! Quero saber mais sobre ${s}.`)} target="_blank" rel="noopener noreferrer" style={{
                  fontSize: "12px", fontWeight: 700, color: color, border: `1px solid ${color}30`,
                  padding: "6px 12px", borderRadius: "8px", flexShrink: 0, background: `${color}08`,
                }}>
                  Falar →
                </a>
              </div>
        ...
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {[
              {
                icon: "⚡",
                title: "Atendimento fácil e direto",
                desc: `Fale direto pelo WhatsApp com a equipe da ${business.business_name}. Sem fila, sem secretária eletrônica.`,
              },
              {
                icon: "🎯",
                title: `Especialistas em ${business.main_service}`,
                desc: `A ${business.business_name} é focada em ${business.main_service} e entende as necessidades de quem busca esse serviço em ${business.city}.`,
              },
              {
                icon: "📍",
                title: `Presente em ${business.city}`,
                desc: `Atendimento local, perto de você. A ${business.business_name} atende em ${business.city} e conhece bem o que o cliente da região precisa.`,
              },
            ].map((item) => (
              <div key={item.title} className="card-lift" style={{
                display: "flex", gap: "16px", alignItems: "flex-start",
                background: "#fafafa", borderRadius: "18px", padding: "20px",
                border: "1.5px solid #f0f0f0", boxShadow: "0 2px 12px rgba(0,0,0,0.04)",
                transition: "all .2s",
              }}>
      ...
      <section style={{ padding: "48px 20px", background: "#f9f9f9" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          ...
          <div style={{ background: "#fff", borderRadius: "20px", overflow: "hidden", border: "1.5px solid #f0f0f0", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}>
            {[
              ...
              <div key={row.day} style={{
                ...
                padding: "16px 20px", borderBottom: i < 2 ? "1px solid #f5f5f5" : "none",
              }}>
          ...
          <a href={waMain} target="_blank" rel="noopener noreferrer" style={{
            display: "flex", alignItems: "center", gap: "8px", marginTop: "14px",
            padding: "13px 16px", background: `${color}0c`, borderRadius: "12px", border: `1px solid ${color}20`,
        ...
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          ...
          <div style={{ background: "#f9f9f9", borderRadius: "20px", padding: "24px", border: "1.5px solid #f0f0f0" }}>
            ...
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              {business.address && (
                <a href={`https://maps.google.com/?q=${encodeURIComponent(`${business.address}, ${business.city}`)}`} target="_blank" rel="noopener noreferrer" style={{
                  display: "flex", alignItems: "center", gap: "8px", flex: 1, minWidth: "140px",
                  background: "#fff", border: "1.5px solid #e5e7eb", borderRadius: "12px", padding: "12px 16px",
                  fontSize: "13px", fontWeight: 700, color: "#333", justifyContent: "center",
                }}>
                  📍 Ver no mapa
                </a>
              )}
              <a href={waMain} target="_blank" rel="noopener noreferrer" className="wa-btn" style={{
                display: "flex", alignItems: "center", gap: "8px", flex: 1, minWidth: "140px",
                background: "#25D366", borderRadius: "12px", padding: "12px 16px",
                fontSize: "13px", fontWeight: 700, color: "#fff", justifyContent: "center",
                boxShadow: "0 4px 16px rgba(37,211,102,0.30)", transition: "transform .2s, box-shadow .2s",
              }}>
      ...
      <section style={{ padding: "60px 20px", background: color, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "560px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <a href={waMain} target="_blank" rel="noopener noreferrer" className="wa-btn" style={{
            ...
            background: "#fff", color: color, fontWeight: 800, fontSize: "17px",
      ...
      <section style={{ padding: "48px 20px", background: "#f9f9f9" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          <div style={{ background: "#fff", borderRadius: "24px", padding: "28px", boxShadow: "0 8px 32px rgba(0,0,0,0.06)", border: "1.5px solid #f0f0f0" }}>
            ...
            <LeadForm businessId={business.id} kitId={kit?.id ?? null} primaryColor={color} />
          </div>
        </div>
      </section>
      ...
      {/* ══ BOTÃO FIXO MOBILE ═════════════════════════════════ */}
      <a href={waMain} target="_blank" rel="noopener noreferrer" className="wa-fixed wa-btn" style={{
